					...
					<div class="row"> 
						<div class="col-lg-6">
							<div class="contact-us-left">
								...
								name email phone selset doc date text area write msg
						...
						<div class="col-lg-6">
								...
								<form method="post" action="addappointment">
									...
									<div class="row mb-3">
									  ...
									  <div class="col-sm-10">
								        ...
								        <option value="${doc.dsno}">${doc.name}-${doc.department}</option>
								        </c:forEach>
							...
							<div class="row mb-3">
									  ...
									  <div class="col-sm-10">
										<input type="submit" class="btn btn-primary">Submit Form</input>
									  </div>
									</div>
